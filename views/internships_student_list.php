		...
		<?php } ?>
				...
				<div class="col-md-12">
					<div class="panel panel-primary">
					  <!-- Default panel contents -->
					   <div class="panel-heading"><h4>Soumissions de stages</h4></div>
					</div>
				</div>
			</div>
			<?php 
				...
				<div class="col-md-12">
					<div class="panel panel-default">
					  	<div class="panel-heading">
					    	<h3 class="panel-title"><?php echo $student->getSurname() . " " . $student->getFirstname() ?></h3>
					  	</div>
					  	<div class="panel-body">
							<div class="row">
					  			<div class="col-md-6">
						    		<h5>Nom de l'entreprise : </h5><p><?php echo $tableInternships[$i]->getFirm()->getName() ?></p>
						    	</div>
						    	<div class="col-md-6">
						    		<h5>Adresse de l'entreprise : </h5><p><?php echo $tableInternships[$i]->getFirm()->getStreet() . " " . $tableInternships[$i]->getFirm()->getNumberStreet() . ", " . $tableInternships[$i]->getFirm()->getZipCode() ?></p>
						    	</div>
					  		</div>
					  		<div class="row">
					  			<div class="col-md-6">
					  		...
					  		<div class="row">
								...
								<div class="col-md-6">
						    		<h5>Etudiant : </h5><p><?php echo $student->getSurname() . " " . $student->getFirstname() ?></p>
						    	</div>
					  		</div>
					  		<div class="row">
					  			<div class="col-md-6">
					  		...
					  		<?php if(isset($_SESSION['job']) && $_SESSION['job']=='manager'){ ?>
								...
								<div class="row">
									...
									<form action="" method="post">
										...
										<button type="submit" name="update" class="btn btn-primary"><span class="glyphicon glyphicon-ok"></span> Je valide cette soumission</button>
									</form>
									</div>
								</div>
								<?php } } ?>
			...
			<div class="row">
				<div class="col-md-12 text-center">
					<div class="alert alert-warning" role="alert">Aucune soumission de stage pour le moment</div>
				</div>
			</div>';
			}
			?>
