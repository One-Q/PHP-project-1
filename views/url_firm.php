...
<form action="index.php?action=url_firm&url=<?php echo $crypt ?>" method="POST" id="form_firm">
	...
	<div class="row">
		<div class="col-md-12">
			<h3>Complétez les informations si nécessaire</h3>
		</div>
	</div>
	<div class="row">
		<div class="col-md-6">
			...
			<p>
				<label>Nom : </label>
				<span><?php echo $internship->getStudent()->getSurname() ?></span>
			</p>
			<p>
				<label >Prénom : </label>
				<span><?php echo $internship->getStudent()->getFirstname() ?></span>
			</p>
			<p>
				<label>Mail : </label>
				<span><?php echo $internship->getStudent()->getMail() ?></span>
			</p>
			<p>
				<label for="student_phone">Numéro : </label>
				<span><?php echo $internship->getStudent()->getPhoneNumber() ?></span>
			</p>
			<p>
				<label for="sex">Sexe : </label>
				<span><?php echo $internship->getStudent()->getSex() ?></span>
			</p>
		</div>
	</div>
	<div class="row">
	...
	<div class="row">
		<div class="col-md-6">
			<div class="panel panel-primary">
				<div class="panel-heading text-center">
			  		<h5><strong>Informations sur la personne contact</strong></h5>
			  	</div>
			</div>
			<p>
